import 'package:flutter_practice/features/destini/data/story.dart';
...
class StoryBrain {
  ...
  final List<Story> _storyData = [
    ...
    Story(
      ...
      choice1: Choice(
        choice: 'I love Elton John! Hand him the cassette tape.',
        destinaton: 5,
      ),
      choice2: Choice(
        choice: 'It\'s him or me! You take the knife and stab him.',
        destinaton: 4,
      ),
    ),
    Story(
  ...
  Story getStory(int index) => _storyData[index];
}
...
//TODO: Step 27 - Create a method call